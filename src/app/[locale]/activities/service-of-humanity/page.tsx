...
import MediaGalleryPage from "../../gallery/page";

const icons = [
  <HandHeart key="1" className="h-5 w-5" />,
  <HeartHandshake key="2" className="h-5 w-5" />,
  <Utensils key="3" className="h-5 w-5" />,
  <Gift key="4" className="h-5 w-5" />,
  <Beef key="5" className="h-5 w-5" />,
  <BriefcaseBusiness key="6" className="h-5 w-5" />,
  <Stethoscope key="7" className="h-5 w-5" />,
  <Droplets key="8" className="h-5 w-5" />,
  <Users key="9" className="h-5 w-5" />,
  <Trees key="10" className="h-5 w-5" />,
];

export default function ServiceHumanityPage() {
  const t = useTranslations("ServiceHumanity");

...
const icons = [
  <Building2 key="1" className="h-5 w-5" />,
  <BookOpen key="2" className="h-5 w-5" />,
  <Mic key="3" className="h-5 w-5" />,
  <Library key="4" className="h-5 w-5" />,
  <ShieldCheck key="5" className="h-5 w-5" />,
  <Video key="6" className="h-5 w-5" />,
];

export default function DawahResearchPage() {
  const t = useTranslations("DawahResearch");
